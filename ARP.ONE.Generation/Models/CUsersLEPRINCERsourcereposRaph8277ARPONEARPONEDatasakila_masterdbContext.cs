...
public partial class CUsersLEPRINCERsourcereposRaph8277ARPONEARPONEDatasakila_masterdbContext : DbContext
{
    public CUsersLEPRINCERsourcereposRaph8277ARPONEARPONEDatasakila_masterdbContext(DbContextOptions<CUsersLEPRINCERsourcereposRaph8277ARPONEARPONEDatasakila_masterdbContext> options)
        : base(options)
    {
    }
