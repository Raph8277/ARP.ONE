...
public partial class GreposRaph8277ARPONEARPONEDatasakila_masterdbContext : DbContext
{
    public GreposRaph8277ARPONEARPONEDatasakila_masterdbContext(DbContextOptions<GreposRaph8277ARPONEARPONEDatasakila_masterdbContext> options)
        : base(options)
    {
    }
